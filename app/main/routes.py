...
def register():
    ...
    if form.validate_on_submit():
        ...
        registration = Registration(
            ...
            arrival_time=form.arrival_time.data.strftime("%H:%M") if form.arrival_time.data else None,
            departure_time=form.departure_time.data.strftime("%H:%M") if form.departure_time.data else None,
...
def edit_registration():
    ...
    if form.validate_on_submit():
        ...
        registration.arrival_time = form.arrival_time.data.strftime("%H:%M") if form.arrival_time.data else None
        registration.departure_time = form.departure_time.data.strftime("%H:%M") if form.departure_time.data else None
