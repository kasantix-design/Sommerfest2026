...
def register():
    ...
    if form.validate_on_submit():
        ...
        flash(
            "Du er nå påmeldt! Valgt arrangement er markert grønt.",
            "success",
        )
...
def my_registration():
    ...
    if not registration:
        flash(
            "Vi fant ingen påmelding på kontoen din.",
            "warning",
        )
...
def edit_registration():
    ...
    if request.method == "GET":
        ...
        form.children_under_10_count.data = (
    ...
    if form.validate_on_submit():
        ...
        flash(
            "Påmeldingen er oppdatert.",
            "success",
        )

        return redirect(
            url_for("main.my_registration")
        )

    return render_template(
        "main/edit_registration.html",
        form=form,
        registration=registration,
    )
